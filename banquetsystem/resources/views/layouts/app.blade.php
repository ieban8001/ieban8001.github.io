...
<head>
    ...
    <title>{{ config('app.name', 'Wedding Banquet System') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @guest
                            <li><a href="{{ route('login') }}"><font color="gray">Login</font></a></li>
                            <li><a href="{{ route('register') }}"><font color="gray">Register</font></a></li>
                        @else
                            <li class="dropdown">
