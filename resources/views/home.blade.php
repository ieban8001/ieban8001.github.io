...
<head>
	<title>Lunch Thyme</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta charset="utf-8">
	<meta name="keywords" content="Lunch Thyme a Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<body>
		...
		<div class="top-bar">
			<div class="header-top_w3layouts">
				...
				<ul class="top-right-info">
					<li><a href="https://web.facebook.com/mylunchthyme/?_rdc=1&_rdr" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
			...
			<div class="header-nav">
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="/home">L<span>unch Thyme</span></a></h1>
					</div>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="top_nav">
								...
								<li><a class="scroll" href="#gallery">Special</a></li>
		...
		<div class="container">
			<div class="news-main_wthree_agile">
				...
				<div class="col-md-6 news-right">
					<p>&nbsp;</p>
					<p><font color="#CF81FC">Lunch Thyme offers food delivery service to your office or home as well as catering services in Klang Valley. Call/Whatsapp Shanice @ 0127980912 for any enquiries!</font>
					</p>
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_1.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_2.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_3.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_4.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
								</div>
							</div>
							<div class="item">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_11.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_12.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_7.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_8.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
								</div>
							</div>
							<div class="item">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_9.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_10.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_11.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
							...
							<div class="item">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_13.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_14.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="images/food_1.jpg" alt="Image" style="max-width:100%;"></div>
									</div>
		...
		<div class="container">
			<div class="about-main_w3_agileits">
				...
				<div class="col-md-6 about-right_agileits">
					...
					<p>Testing Testing Testing Testing Testing
						...
						<div class="recipe-grid">
							<div class="col-md-6 menu-grids">
								<div class="menu-text_wthree">
									...
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_1.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
								...
								<div class="menu-text_wthree">
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_2.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
								...
								<div class="menu-text_wthree">
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_3.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
							...
							<div class="col-md-6 menu-grids">
								<div class="menu-text_wthree">
									...
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_4.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
								...
								<div class="menu-text_wthree">
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_5.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
								...
								<div class="menu-text_wthree">
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_6.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
						...
						<div class="recipe-grid">
							<div class="col-md-6 menu-grids">
								<div class="menu-text_wthree">
									...
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_7.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
								...
								<div class="menu-text_wthree">
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_8.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
								...
								<div class="menu-text_wthree">
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_9.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
							...
							<div class="col-md-6 menu-grids">
								<div class="menu-text_wthree">
									...
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_10.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
								...
								<div class="menu-text_wthree">
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_11.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
								...
								<div class="menu-text_wthree">
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_12.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
						...
						<div class="recipe-grid">
							<div class="col-md-6 menu-grids">
								<div class="menu-text_wthree">
									...
									<div class="menu-text-left">
										<div class="rep-img">
											<img src="images/food_13.jpg" alt=" " class="img-responsive">
										</div>
										<div class="rep-text">
											<h4>Testing</h4>
											<h6>with wild mushrooms and asparagus</h6>
			...
			<div class="gallery-main">
				...
				<div class="gallery-top">
					<div class="gallery-top-img portfolio-grids">
						<a href="images/food_2.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
									<img src="images/food_2.jpg" class="img-responsive" alt="" />
									<div class="p-mask">
					...
					<div class="gallery-top-img portfolio-grids">
						<a href="images/food_3.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
									<img src="images/food_3.jpg" class="img-responsive" alt="" />
									<div class="p-mask">
										<h4><span>Testing</span></h4>
									</div>
								</a>
				...
				<div class="comments-top">
					<div class="col-md-4 comments-bottom">
						...
						<div class="comments-right">
							...
							<p class="para2">Testing Testing Testing Testing Testing</p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 comments-bottom">
					...
					<div class="col-md-4 comments-bottom">
						...
						<div class="comments-right">
							<h3>Testing</h3>
							<p class="para1">Testing</p>
							<p class="para2">Testing Testing Testing Testing Testing
	...
	<!-- /contact -->
	<div class="copy">
		<p>&copy; 2018 Lunch Thyme. All rights reserved</p>
